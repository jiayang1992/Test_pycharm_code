...
class Case(unittest.TestCase):
    ...
    def test_case(self):
        ...
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | null | ]]
        driver.switch_to_frame(driver.find_element_by_id("atrDialogIframe_addPartyWorkId"))
        ...
        driver.switch_to_frame(driver.find_element_by_id("iframeMenuEdit"))
        driver.switch_to_frame(driver.find_element_by_id("atrDialogIframe_addPartyWorkId"))
        driver.find_element_by_name("orderTitle").clear()
        driver.find_element_by_name("orderTitle").send_keys(u"污水处理及改善")
        driver.find_element_by_name("orderContent").clear()
        driver.find_element_by_name("orderContent").send_keys(u"尽快处理二府湾附近的污水池")
        ...
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        driver.switch_to_frame(driver.find_element_by_id("iframeMenuEdit"))
        driver.find_element_by_xpath(u"(//a[contains(text(),'查看')])[6]").click()
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | null | ]]
        ...
        print("工作指导接收下共有%d条消息" % int(value2))
                ...
                # print("工作指导接收下共有%d条消息" % int(value3))
        ...
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | null | ]]
                ...
                # print("工作指导接收下共有%d条消息" % int(value))
                # driver.switch_to_default_content()
                # driver.find_element_by_id("second-30").click()
                # driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
                # driver.find_element_by_id("partGroupTree_1_span").click()
                ...
                # print("工作指导接收下共有%d条消息" % int(value1))
        driver.switch_to_default_content()
