...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_id("second-72").click()
        ...
        time.sleep(5)
        driver.find_element_by_link_text(u"图形").click()
        driver.find_element_by_css_selector("#profile > div > span").click()
        driver.find_element_by_css_selector("div.widget-main.padding-4").click()
        driver.find_element_by_css_selector("i.green.icon-home.bigger-110").click()
        time.sleep(5)
        driver.find_element_by_link_text(u"重置").click()
        # ERROR: Caught exception [ERROR: Unsupported command [selectFrame | relative=parent | ]]
        driver.switch_to_default_content()
