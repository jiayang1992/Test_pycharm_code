...
class Case2015(unittest.TestCase):
    ...
    def test_case2015(self):
        ...
        Select(driver.find_element_by_id("alterYearId")).select_by_visible_text(u"2016年度")
