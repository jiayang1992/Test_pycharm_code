...
class Case2016(unittest.TestCase):
    ...
    def test_case2016(self):
        ...
        driver.find_element_by_id("menuli11").click()
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        Select(driver.find_element_by_id("villageAttriId")).select_by_visible_text(u"贫困村")
        Select(driver.find_element_by_name("alterYear")).select_by_visible_text(u"2016年度")
