...
class Case(unittest.TestCase):
    ...
    def test_case(self):
        ...
        driver.find_element_by_id("310051696055").click()
        ...
        driver.find_element_by_id("310051696055").click()
        driver.find_element_by_id("310051696056").click()
        ...
        self.assertEqual(u"网络异常异常，请检查网络连接！", self.close_alert_and_get_its_text())
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | null | ]]
        driver.switch_to_default_content()
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        driver.find_element_by_id("closeId").click()
        time.sleep(5)
        driver.find_element_by_id("310051793287").click()
        driver.switch_to_frame(driver.find_element_by_id("atrDialogIframe_userId"))
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | null | ]]
        driver.find_element_by_id("switch-big2").click()
        driver.find_element_by_id("switch-big3").click()
