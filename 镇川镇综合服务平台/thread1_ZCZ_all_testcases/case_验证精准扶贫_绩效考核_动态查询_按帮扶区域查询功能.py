...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        ...
        driver.find_element_by_id("menuli24").click()
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        # ERROR: Caught exception [ERROR: Unsupported command [selectFrame | index=0 | ]]
        driver.find_element_by_name("town").click()
        Select(driver.find_element_by_name("town")).select_by_visible_text(u"镇川镇")
        driver.find_element_by_css_selector("option[value=\"610802028000\"]").click()
        ...
        driver.find_element_by_link_text("815").click()
        driver.find_element_by_link_text("75").click()
        driver.find_element_by_link_text(u"点此返回").click()
        driver.find_element_by_link_text("72").click()
        driver.find_element_by_link_text(u"点此返回").click()
        driver.find_element_by_link_text("39").click()
        driver.find_element_by_link_text(u"点此返回").click()
        ...
        driver.find_element_by_xpath("/html/body/div/div[1]/div[1]/a").click()
        driver.find_element_by_xpath("/html/body/div/div[1]/div[6]/a").click()
        driver.find_element_by_xpath("/html/body/div/div[3]/table/tbody/tr[3]/td[7]").click()
        driver.switch_to_default_content()
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        driver.find_element_by_id("endDate").click()
        driver.switch_to_default_content()
        driver.switch_to_frame(driver.find_element_by_xpath("/html/body/div[1]/iframe"))
        driver.find_element_by_xpath("/html/body/div/div[3]/table/tbody/tr[5]/td[4]").click()
        driver.switch_to_default_content()
        driver.switch_to_frame(driver.find_element_by_class_name("iframeClass"))
        driver.find_element_by_id("queryBtn").click()
        driver.find_element_by_xpath(u"//button[@value='导出']").click()
        ...
        driver.find_element_by_link_text(u"点此返回").click()
        driver.find_element_by_css_selector("button.form-btn").click()
        driver.find_element_by_link_text("298").click()
        driver.find_element_by_css_selector("button.form-btn").click()
        driver.find_element_by_link_text("819").click()
        driver.find_element_by_link_text("75").click()
        driver.find_element_by_link_text(u"点此返回").click()
        driver.find_element_by_css_selector("button.form-btn").click()
