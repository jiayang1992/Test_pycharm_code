...
class Case(unittest.TestCase):
    ...
    def test_case(self):
        ...
        driver.find_element_by_name("title").send_keys("2017")
        driver.find_element_by_id("queryBtn").click()
        driver.find_element_by_name("title").clear()
        driver.find_element_by_name("title").send_keys(u"2017年第一季度")
        driver.find_element_by_id("queryBtn").click()
        driver.find_element_by_name("title").clear()
        driver.find_element_by_name("title").send_keys(u"2017年第一季度党员发展情况")
        driver.find_element_by_id("queryBtn").click()
